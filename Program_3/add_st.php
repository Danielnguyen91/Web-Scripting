<?php
/* Toan Nguyen
Admin Page to add more student to the database */
...
VALUES ('$wid','$pass','$lname','$fname','$phone','$email','$Track','1')");
mysqli_close($DBConnect);
echo "The Student information is already add to database"; echo "</br>";	
}
...
<html><head>Add more student page</title> </head>
<body> 
<?php		
		if ( $check_id_message != '' ) {
...
<p>Admin add student by filling all the information below</p>
